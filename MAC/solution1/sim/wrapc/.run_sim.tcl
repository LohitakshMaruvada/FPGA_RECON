...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "MAC.autotvin.dat"
	set constFileTvOut       "MAC.autotvout.dat"
	set constFileHdlTvIn     "MAC.autohdltvin.dat"
	set constFileHdlTvOut    "MAC.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
