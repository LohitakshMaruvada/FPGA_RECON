...
float apatb_neuron_sw(float , signed int );
...
printf("\n\{ BEGIN @main\n");
if (AESL_DEBUG_TRACE)
printf("\n  %%1 = tail call float @apatb_neuron_sw(float 0x3FB99999A0000000, i32 1) nounwind, !dbg !2 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_9_count);
  llvm_cbe_tmp__1 = (float ) /*tail*/ apatb_neuron_sw(0x1.99999ap-4, 1u);
if (AESL_DEBUG_TRACE) {
...
if (AESL_DEBUG_TRACE)
printf("\n  %%9 = tail call float @apatb_neuron_sw(float 0x3FD3333340000000, i32 1) nounwind, !dbg !2 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_26_count);
  llvm_cbe_tmp__9 = (float ) /*tail*/ apatb_neuron_sw(0x1.333334p-2, 1u);
if (AESL_DEBUG_TRACE) {
...
if (AESL_DEBUG_TRACE)
printf("\n  %%17 = tail call float @apatb_neuron_sw(float 0x3FE3333340000000, i32 1) nounwind, !dbg !2 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_43_count);
  llvm_cbe_tmp__17 = (float ) /*tail*/ apatb_neuron_sw(0x1.333334p-1, 1u);
if (AESL_DEBUG_TRACE) {
...
if (AESL_DEBUG_TRACE)
printf("\n  %%25 = tail call float @apatb_neuron_sw(float 5.000000e-01, i32 1) nounwind, !dbg !2 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_60_count);
  llvm_cbe_tmp__25 = (float ) /*tail*/ apatb_neuron_sw(0x1p-1, 1u);
if (AESL_DEBUG_TRACE) {
printf("\nArgument  = %f",0x1p-1);
printf("\nArgument  = 0x%X",1u);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%33 = tail call float @apatb_neuron_sw(float 1.000000e+00, i32 1) nounwind, !dbg !2 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_77_count);
  llvm_cbe_tmp__33 = (float ) /*tail*/ apatb_neuron_sw(0x1p0, 1u);
if (AESL_DEBUG_TRACE) {
printf("\nArgument  = %f",0x1p0);
printf("\nArgument  = 0x%X",1u);
