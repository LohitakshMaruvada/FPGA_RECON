...
HD_PWD='C:/Users/chait/OneDrive/Desktop/FPGA/Project/tanh/hyperbolic_tan/hyperbolic_tan.runs/tanh_custom_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log tanh_custom_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source tanh_custom_0.tcl
