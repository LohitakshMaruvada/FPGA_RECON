...
entity tanh_custom_tanh_custom_Pipeline_VITIS_LOOP_14_1 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of tanh_custom_tanh_custom_Pipeline_VITIS_LOOP_14_1 is 
...
attribute shreg_extract : string;
    ...
    signal icmp_ln14_reg_328 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal tanh_custom_tanh_in_address0 : STD_LOGIC_VECTOR (3 downto 0);
    signal tanh_custom_tanh_in_ce0 : STD_LOGIC;
    signal tanh_custom_tanh_in_q0 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal icmp_ln14_fu_177_p2 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal tanh_custom_tanh_in_load_reg_357 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal add_ln14_fu_183_p2 : STD_LOGIC_VECTOR (2 downto 0);
    ...
    signal bitcast_ln16_fu_207_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_fu_210_p4 : STD_LOGIC_VECTOR (7 downto 0);
    signal trunc_ln16_fu_220_p1 : STD_LOGIC_VECTOR (22 downto 0);
    signal icmp_ln16_1_fu_230_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln16_fu_224_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal or_ln16_fu_236_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal grp_fu_128_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal and_ln16_fu_242_p2 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    component tanh_custom_faddfsub_32ns_32ns_32_7_full_dsp_1 IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
    ...
    component tanh_custom_fadd_32ns_32ns_32_7_full_dsp_1 IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
    ...
    component tanh_custom_fmul_32ns_32ns_32_4_max_dsp_1 IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
    ...
    component tanh_custom_fcmp_32ns_32ns_1_2_no_dsp_1 IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
    ...
    component tanh_custom_tanh_custom_Pipeline_VITIS_LOOP_14_1_tanh_custom_tanh_in_ROM_AUTO_1R IS
    generic (
        DataWidth : INTEGER;
    ...
    component tanh_custom_flow_control_loop_pipe_sequential_init IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
...
begin
    tanh_custom_tanh_in_U : component tanh_custom_tanh_custom_Pipeline_VITIS_LOOP_14_1_tanh_custom_tanh_in_ROM_AUTO_1R
    generic map (
        DataWidth => 32,
        AddressRange => 13,
        AddressWidth => 4)
    port map (
        clk => ap_clk,
        reset => ap_rst,
        address0 => tanh_custom_tanh_in_address0,
        ce0 => tanh_custom_tanh_in_ce0,
        q0 => tanh_custom_tanh_in_q0);

    faddfsub_32ns_32ns_32_7_full_dsp_1_U1 : component tanh_custom_faddfsub_32ns_32ns_32_7_full_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 7,
        din0_WIDTH => 32,
    ...
    fadd_32ns_32ns_32_7_full_dsp_1_U2 : component tanh_custom_fadd_32ns_32ns_32_7_full_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 7,
        din0_WIDTH => 32,
    ...
    fmul_32ns_32ns_32_4_max_dsp_1_U3 : component tanh_custom_fmul_32ns_32ns_32_4_max_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 4,
        din0_WIDTH => 32,
    ...
    fmul_32ns_32ns_32_4_max_dsp_1_U4 : component tanh_custom_fmul_32ns_32ns_32_4_max_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 4,
        din0_WIDTH => 32,
    ...
    fcmp_32ns_32ns_1_2_no_dsp_1_U5 : component tanh_custom_fcmp_32ns_32ns_1_2_no_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 32,
    ...
    flow_control_loop_pipe_sequential_init_U : component tanh_custom_flow_control_loop_pipe_sequential_init
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
        ap_start => ap_start,
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            ...
            elsif (((ap_const_boolean_0 = ap_block_pp0_stage1_11001) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage1) and (icmp_ln14_fu_177_p2 = ap_const_lv1_0))) then 
                i_fu_74 <= add_ln14_fu_183_p2;
            end if; 
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            ...
            elsif (((icmp_ln14_reg_328 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage5_11001) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage5))) then 
                pow_fu_70 <= reg_133;
            end if; 
        end if;
    end process;
        ...
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                if ((ap_loop_init = ap_const_logic_1)) then 
                    z_fu_66 <= angle;
                elsif (((icmp_ln14_reg_328 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1))) then 
                    z_fu_66 <= reg_145;
                end if;
            end if; 
        end if;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln14_reg_328 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage2_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage2))) then
                    d_reg_351(31) <= d_fu_248_p3(31);
                tanh_custom_tanh_in_load_reg_357 <= tanh_custom_tanh_in_q0;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage1_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage1))) then
                icmp_ln14_reg_328 <= icmp_ln14_fu_177_p2;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln14_reg_328 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage7_11001) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage7))) then
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage1_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage1) and (icmp_ln14_fu_177_p2 = ap_const_lv1_0))) then
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((((icmp_ln14_reg_328 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage4_11001) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage4)) or ((icmp_ln14_reg_328 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage10_11001) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage10)) or ((icmp_ln14_reg_328 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage6_11001) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage6)))) then
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((((icmp_ln14_reg_328 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage10_11001) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage10)) or ((icmp_ln14_reg_328 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage6_11001) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage6)))) then
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((((ap_const_boolean_0 = ap_block_pp0_stage2_11001) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage2)) or ((icmp_ln14_reg_328 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage14_11001) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage14)))) then
                reg_145 <= grp_fu_111_p2;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln14_reg_328 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage3_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage3))) then
    ...
    add_ln14_fu_183_p2 <= std_logic_vector(unsigned(i_fu_74) + unsigned(ap_const_lv3_1));
    and_ln16_fu_242_p2 <= (or_ln16_fu_236_p2 and grp_fu_128_p2);
    ...
    ap_condition_exit_pp0_iter0_stage3_assign_proc : process(ap_enable_reg_pp0_iter0, ap_CS_fsm_pp0_stage3, ap_block_pp0_stage3_subdone, icmp_ln14_reg_328)
    begin
        if (((icmp_ln14_reg_328 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage3_subdone) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage3))) then 
    ...
    bitcast_ln16_fu_207_p1 <= z_load_reg_332;
    d_fu_248_p3 <= 
        ap_const_lv32_3F800000 when (and_ln16_fu_242_p2(0) = '1') else 
        ap_const_lv32_BF800000;

    grp_fu_111_opcode_assign_proc : process(ap_enable_reg_pp0_iter0, icmp_ln14_reg_328, ap_CS_fsm_pp0_stage8, ap_CS_fsm_pp0_stage11, ap_block_pp0_stage11_00001, ap_block_pp0_stage8_00001)
    begin
        if (((icmp_ln14_reg_328 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1))) then
    ...
    grp_fu_119_p1_assign_proc : process(ap_enable_reg_pp0_iter0, ap_CS_fsm_pp0_stage3, ap_CS_fsm_pp0_stage4, ap_CS_fsm_pp0_stage1, pow_load_reg_339, tanh_custom_tanh_in_load_reg_357, ap_CS_fsm_pp0_stage7, ap_block_pp0_stage1, ap_sig_allocacmp_y_load, ap_block_pp0_stage3, ap_block_pp0_stage4, ap_block_pp0_stage7)
    begin
        if ((ap_enable_reg_pp0_iter0 = ap_const_logic_1)) then
            if (((ap_const_boolean_0 = ap_block_pp0_stage7) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage7))) then 
                grp_fu_119_p1 <= pow_load_reg_339;
            elsif (((ap_const_boolean_0 = ap_block_pp0_stage4) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage4))) then 
                grp_fu_119_p1 <= tanh_custom_tanh_in_load_reg_357;
    ...
    icmp_ln14_fu_177_p2 <= "1" when (i_fu_74 = ap_const_lv3_5) else "0";
    icmp_ln16_1_fu_230_p2 <= "1" when (trunc_ln16_fu_220_p1 = ap_const_lv23_0) else "0";
    icmp_ln16_fu_224_p2 <= "0" when (tmp_fu_210_p4 = ap_const_lv8_FF) else "1";
    or_ln16_fu_236_p2 <= (icmp_ln16_fu_224_p2 or icmp_ln16_1_fu_230_p2);
    tanh_custom_tanh_in_address0 <= i_cast_fu_197_p1(4 - 1 downto 0);

    tanh_custom_tanh_in_ce0_assign_proc : process(ap_enable_reg_pp0_iter0, ap_CS_fsm_pp0_stage1, ap_block_pp0_stage1_11001)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage1_11001) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage1))) then 
            tanh_custom_tanh_in_ce0 <= ap_const_logic_1;
        else 
            tanh_custom_tanh_in_ce0 <= ap_const_logic_0;
        end if; 
    end process;

    tmp_fu_210_p4 <= bitcast_ln16_fu_207_p1(30 downto 23);
    trunc_ln16_fu_220_p1 <= bitcast_ln16_fu_207_p1(23 - 1 downto 0);
    x_2_out <= xold_fu_62;

    x_2_out_ap_vld_assign_proc : process(ap_CS_fsm_pp0_stage3, icmp_ln14_reg_328, ap_block_pp0_stage3_11001)
    begin
        if (((icmp_ln14_reg_328 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage3_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage3))) then 
    ...
    y_out_ap_vld_assign_proc : process(ap_CS_fsm_pp0_stage3, icmp_ln14_reg_328, ap_block_pp0_stage3_11001)
    begin
        if (((icmp_ln14_reg_328 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage3_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage3))) then 
