...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "neuron.autotvin.dat"
	set constFileTvOut       "neuron.autotvout.dat"
	set constFileHdlTvIn     "neuron.autohdltvin.dat"
	set constFileHdlTvOut    "neuron.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
