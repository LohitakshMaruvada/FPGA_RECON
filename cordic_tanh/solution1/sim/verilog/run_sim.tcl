...
if {[file isfile tanh_custom.autotvin.dat]} {
	file delete -force tanh_custom.autotvin.dat
}

if {[file isfile tanh_custom.autotvout.dat]} {
	file delete -force tanh_custom.autotvout.dat
}
