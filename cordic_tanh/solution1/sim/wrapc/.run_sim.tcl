...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "tanh_custom.autotvin.dat"
	set constFileTvOut       "tanh_custom.autotvout.dat"
	set constFileHdlTvIn     "tanh_custom.autohdltvin.dat"
	set constFileHdlTvOut    "tanh_custom.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
