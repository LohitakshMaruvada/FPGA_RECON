...
// wrapc file define:
#define AUTOTB_TVIN_angle "../tv/cdatafile/c.neuron.autotvin_angle.dat"
#define AUTOTB_TVOUT_angle "../tv/cdatafile/c.neuron.autotvout_angle.dat"
#define AUTOTB_TVIN_sel "../tv/cdatafile/c.neuron.autotvin_sel.dat"
#define AUTOTB_TVOUT_sel "../tv/cdatafile/c.neuron.autotvout_sel.dat"
#define AUTOTB_TVOUT_return "../tv/cdatafile/c.neuron.autotvout_ap_return.dat"


// tvout file define:
#define AUTOTB_TVOUT_PC_return "../tv/rtldatafile/rtl.neuron.autotvout_ap_return.dat"
...
extern "C"
float neuron_hw_stub_wrapper(float, hls::sim::Byte<4>);

extern "C"
float apatb_neuron_hw(float __xlx_apatb_param_angle, hls::sim::Byte<4> __xlx_apatb_param_sel)
{
  float ap_return;
...
#else
    .owriter = nullptr,
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_angle),
#endif
  };
  port1.param = &__xlx_apatb_param_angle;
  ...
  try {
    ...
    ap_return = neuron_hw_stub_wrapper(__xlx_apatb_param_angle, __xlx_apatb_param_sel);
