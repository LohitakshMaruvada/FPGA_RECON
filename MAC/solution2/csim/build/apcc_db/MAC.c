...
printf("\n\{ BEGIN @MAC\n");
  if ((((signed int )llvm_cbe_j) > ((signed int )0u))) {
    ...
    llvm_cbe__2e_lcssa__PHI_TEMPORARY = (float )llvm_cbe_c;   /* for PHI node */
...
if (AESL_DEBUG_TRACE)
printf("\n  %%storemerge2 = phi i32 [ %%13, %%.lr.ph ], [ 0, %%0  for 0x%I64xth hint within @MAC  --> \n", ++aesl_llvm_cbe_storemerge2_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%2 = phi float [ %%9, %%.lr.ph ], [ %%c, %%0  for 0x%I64xth hint within @MAC  --> \n", ++aesl_llvm_cbe_29_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%3 = phi float [ %%11, %%.lr.ph ], [ %%b, %%0  for 0x%I64xth hint within @MAC  --> \n", ++aesl_llvm_cbe_30_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%4 = phi float [ %%12, %%.lr.ph ], [ 1.000000e+00, %%0  for 0x%I64xth hint within @MAC  --> \n", ++aesl_llvm_cbe_31_count);
...
printf("\n = 0x%X\n", ((unsigned int )(llvm_cbe_tmp__11&4294967295ull)));
  if (((llvm_cbe_tmp__11&4294967295U) == (llvm_cbe_j&4294967295U))) {
    llvm_cbe__2e_lcssa__PHI_TEMPORARY = (float )llvm_cbe_tmp__7;   /* for PHI node */
    goto llvm_cbe__2e__crit_edge;
  } else {
...
if (AESL_DEBUG_TRACE)
printf("\n  %%.lcssa = phi float [ %%c, %%0 ], [ %%9, %%.lr.ph  for 0x%I64xth hint within @MAC  --> \n", ++aesl_llvm_cbe__2e_lcssa_count);
