...
HD_PWD='C:/Users/chait/OneDrive/Desktop/FPGA/Project/tanh/neuron_ipcheck/neuron_ipcheck.runs/neuron_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log neuron_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source neuron_0.tcl
