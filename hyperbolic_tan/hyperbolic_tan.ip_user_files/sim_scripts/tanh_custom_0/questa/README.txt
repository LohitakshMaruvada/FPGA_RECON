...
#
# Generated by export_simulation on Mon Nov 04 00:30:54 +0530 2024
#
################################################################################
...
'-reset_run' switch to the './tanh_custom_0.sh' script.

./tanh_custom_0.sh -reset_run
...
./tanh_custom_0.sh -noclean_files

For more information on the script, please type './tanh_custom_0.sh -help'.
