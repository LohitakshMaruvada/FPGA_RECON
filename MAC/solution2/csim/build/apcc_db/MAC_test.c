...
float MAC(float , float , float , signed int );
...
printf("\n\{ BEGIN @main\n");
if (AESL_DEBUG_TRACE)
printf("\n  %%1 = tail call float @MAC(float 5.000000e-01, float 1.000000e+00, float 0.000000e+00, i32 5) nounwind, !dbg !3 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_14_count);
  llvm_cbe_tmp__1 = (float ) /*tail*/ MAC(0x1p-1, 0x1p0, 0x0p0, 5u);
if (AESL_DEBUG_TRACE) {
printf("\nArgument  = %f",0x1p-1);
printf("\nArgument  = %f",0x1p0);
printf("\nArgument  = %f",0x0p0);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%9 = tail call float @MAC(float 0x3FC99999A0000000, float 2.000000e+00, float 5.000000e-01, i32 5) nounwind, !dbg !3 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_34_count);
  llvm_cbe_tmp__8 = (float ) /*tail*/ MAC(0x1.99999ap-3, 0x1p1, 0x1p-1, 5u);
if (AESL_DEBUG_TRACE) {
...
if (AESL_DEBUG_TRACE)
printf("\n  %%17 = tail call float @MAC(float 0x3FD3333340000000, float 3.000000e+00, float 0x3FD3333340000000, i32 5) nounwind, !dbg !3 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_54_count);
  llvm_cbe_tmp__15 = (float ) /*tail*/ MAC(0x1.333334p-2, 0x1.8p1, 0x1.333334p-2, 5u);
if (AESL_DEBUG_TRACE) {
...
if (AESL_DEBUG_TRACE)
printf("\n  %%25 = tail call float @MAC(float 0x3FD99999A0000000, float 2.000000e+00, float 0x3FC99999A0000000, i32 5) nounwind, !dbg !3 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_74_count);
  llvm_cbe_tmp__22 = (float ) /*tail*/ MAC(0x1.99999ap-2, 0x1p1, 0x1.99999ap-3, 5u);
if (AESL_DEBUG_TRACE) {
...
if (AESL_DEBUG_TRACE)
printf("\n  %%33 = tail call float @MAC(float 5.000000e-01, float 1.000000e+00, float 0x3FD3333340000000, i32 5) nounwind, !dbg !3 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_94_count);
  llvm_cbe_tmp__29 = (float ) /*tail*/ MAC(0x1p-1, 0x1p0, 0x1.333334p-2, 5u);
if (AESL_DEBUG_TRACE) {
printf("\nArgument  = %f",0x1p-1);
printf("\nArgument  = %f",0x1p0);
printf("\nArgument  = %f",0x1.333334p-2);
