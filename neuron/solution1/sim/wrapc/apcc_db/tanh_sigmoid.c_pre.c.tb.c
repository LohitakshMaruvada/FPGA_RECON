...
float neuron_hw_stub(float llvm_cbe_angle, signed int llvm_cbe_sel);
float apatb_neuron_sw(float llvm_cbe_angle, signed int llvm_cbe_sel);
float apatb_neuron_ir(float , signed int );
...
if (AESL_DEBUG_TRACE)
printf("\n  %%5 = fmul float %%storemerge2, 0x3FF453F7C0000000, !dbg !4 for 0x%I64xth hint within @neuron  --> \n", ++aesl_llvm_cbe_34_count);
  llvm_cbe_tmp__4 = (float )((float )(llvm_cbe_storemerge2 * 0x1.453f7cp0));
if (AESL_DEBUG_TRACE)
printf("\n = %f,  0x%x\n", llvm_cbe_tmp__4, *(int*)(&llvm_cbe_tmp__4));
if (AESL_DEBUG_TRACE)
printf("\n  %%6 = fmul float %%5, 5.000000e-01, !dbg !4 for 0x%I64xth hint within @neuron  --> \n", ++aesl_llvm_cbe_35_count);
  llvm_cbe_tmp__5 = (float )((float )(llvm_cbe_tmp__4 * 0x1p-1));
if (AESL_DEBUG_TRACE)
printf("\n = %f,  0x%x\n", llvm_cbe_tmp__5, *(int*)(&llvm_cbe_tmp__5));
if (AESL_DEBUG_TRACE)
printf("\n  %%7 = fadd float %%6, 0.000000e+00, !dbg !4 for 0x%I64xth hint within @neuron  --> \n", ++aesl_llvm_cbe_36_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%storemerge1 = select i1 %%49, float %%44, float %%48, !dbg !3 for 0x%I64xth hint within @neuron  --> \n", ++aesl_llvm_cbe_storemerge1_count);
...
const char* AESL_DEBUG_TRACE = getenv("DEBUG_TRACE");
if (AESL_DEBUG_TRACE)
printf("\n\{ BEGIN @neuron_hw_stub\n");
if (AESL_DEBUG_TRACE)
printf("\n  %%1 = tail call float @neuron(float %%angle, i32 %%sel), !dbg !2 for 0x%I64xth hint within @neuron_hw_stub  --> \n", ++aesl_llvm_cbe_189_count);
  llvm_cbe_tmp__44 = (float ) /*tail*/ neuron(llvm_cbe_angle, llvm_cbe_sel);
if (AESL_DEBUG_TRACE) {
printf("\nArgument angle = %f,  0x%x",llvm_cbe_angle, *(int*)(&llvm_cbe_angle));
printf("\nArgument sel = 0x%X",llvm_cbe_sel);
...
const char* AESL_DEBUG_TRACE = getenv("DEBUG_TRACE");
if (AESL_DEBUG_TRACE)
printf("\n\{ BEGIN @apatb_neuron_sw\n");
if (AESL_DEBUG_TRACE)
printf("\n  %%1 = tail call float @apatb_neuron_ir(float %%angle, i32 %%sel) nounwind, !dbg !2 for 0x%I64xth hint within @apatb_neuron_sw  --> \n", ++aesl_llvm_cbe_197_count);
  llvm_cbe_tmp__45 = (float ) /*tail*/ apatb_neuron_ir(llvm_cbe_angle, llvm_cbe_sel);
if (AESL_DEBUG_TRACE) {
printf("\nArgument angle = %f,  0x%x",llvm_cbe_angle, *(int*)(&llvm_cbe_angle));
printf("\nArgument sel = 0x%X",llvm_cbe_sel);
