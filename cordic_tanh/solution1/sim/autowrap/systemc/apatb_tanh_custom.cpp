...
#define AUTOTB_TVOUT_angle "../tv/cdatafile/c.tanh_custom.autotvout_angle.dat"
#define AUTOTB_TVOUT_return "../tv/cdatafile/c.tanh_custom.autotvout_ap_return.dat"


// tvout file define:
#define AUTOTB_TVOUT_PC_return "../tv/rtldatafile/rtl.tanh_custom.autotvout_ap_return.dat"
...
extern "C"
float tanh_custom_hw_stub_wrapper(float);

extern "C"
float apatb_tanh_custom_hw(float __xlx_apatb_param_angle)
{
  float ap_return;
  ...
  try {
    ...
    ap_return = tanh_custom_hw_stub_wrapper(__xlx_apatb_param_angle);
