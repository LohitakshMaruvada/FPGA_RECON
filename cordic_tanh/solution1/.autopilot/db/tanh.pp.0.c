...
__attribute__((sdx_kernel("tanh_custom", 0))) float tanh_custom(float angle);
# 2 "tanh.c" 2
...
__attribute__((sdx_kernel("tanh_custom", 0))) float tanh_custom(float angle){
#line 14 "C:/Users/chait/OneDrive/Desktop/FPGA/Project/tanh/cordic_tanh/solution1/csynth.tcl"
#pragma HLSDIRECTIVE TOP name=tanh_custom
# 4 "tanh.c"
    ...
    float pow = 0.5;
    float d;
    VITIS_LOOP_14_1: for (int i = 0; i < 5; i++)
    {
        if (z > 0)
        {
            d = 1.0;
