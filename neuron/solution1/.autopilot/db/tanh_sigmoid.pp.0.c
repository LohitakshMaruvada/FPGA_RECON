...
__attribute__((sdx_kernel("neuron", 0))) float neuron(float angle, int sel);
# 2 "tanh_sigmoid.c" 2
...
__attribute__((sdx_kernel("neuron", 0))) float neuron(float angle, int sel){
#line 15 "C:/Users/chait/OneDrive/Desktop/FPGA/Project/tanh/neuron/solution1/csynth.tcl"
#pragma HLSDIRECTIVE TOP name=neuron
# 4 "tanh_sigmoid.c"

#line 6 "C:/Users/chait/OneDrive/Desktop/FPGA/Project/tanh/neuron/solution1/directives.tcl"
#pragma HLSDIRECTIVE TOP name=neuron
# 4 "tanh_sigmoid.c"
    ...
    float pow = 0.5;
    float d;
    VITIS_LOOP_15_1: for (int i = 0; i < 5; i++)
    {
        if (z > 0)
        {
            d = 1.0;
