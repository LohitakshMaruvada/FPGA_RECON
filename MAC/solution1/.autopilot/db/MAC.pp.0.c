...
__attribute__((sdx_kernel("MAC", 0))) float MAC(float a, float b, float c, int j);
# 2 "MAC.c" 2
...
__attribute__((sdx_kernel("MAC", 0))) float MAC(float a, float b, float c, int j)
{
#line 15 "C:/Users/chait/OneDrive/Desktop/FPGA/Project/MAC/MAC/solution1/csynth.tcl"
#pragma HLSDIRECTIVE TOP name=MAC
# 8 "MAC.c"

#line 6 "C:/Users/chait/OneDrive/Desktop/FPGA/Project/MAC/MAC/solution1/directives.tcl"
#pragma HLSDIRECTIVE TOP name=MAC
# 8 "MAC.c"
    ...
    float mac;
    select = 0;
    VITIS_LOOP_26_1: for (int i = 0; i < j; i++)
    {
        if (z > 0)
        {
            d = 1;
    ...
    if (select)
    {
        ...
        pow = 0.5;
        VITIS_LOOP_56_2: for (int i = 0; i < j; i++)
        {
            if (z > 0)
            {
                d = 1;
