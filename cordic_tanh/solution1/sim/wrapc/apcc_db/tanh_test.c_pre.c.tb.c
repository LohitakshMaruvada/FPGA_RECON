...
float apatb_tanh_custom_sw(float );
...
printf("\n\{ BEGIN @main\n");
if (AESL_DEBUG_TRACE)
printf("\n  %%1 = tail call float @apatb_tanh_custom_sw(float 0x3FB99999A0000000) nounwind, !dbg !2 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_7_count);
  llvm_cbe_tmp__1 = (float ) /*tail*/ apatb_tanh_custom_sw(0x1.99999ap-4);
if (AESL_DEBUG_TRACE) {
...
if (AESL_DEBUG_TRACE)
printf("\n  %%9 = tail call float @apatb_tanh_custom_sw(float 0x3FD3333340000000) nounwind, !dbg !2 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_24_count);
  llvm_cbe_tmp__9 = (float ) /*tail*/ apatb_tanh_custom_sw(0x1.333334p-2);
if (AESL_DEBUG_TRACE) {
...
if (AESL_DEBUG_TRACE)
printf("\n  %%17 = tail call float @apatb_tanh_custom_sw(float 0x3FE3333340000000) nounwind, !dbg !2 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_41_count);
  llvm_cbe_tmp__17 = (float ) /*tail*/ apatb_tanh_custom_sw(0x1.333334p-1);
if (AESL_DEBUG_TRACE) {
...
if (AESL_DEBUG_TRACE)
printf("\n  %%25 = tail call float @apatb_tanh_custom_sw(float 5.000000e-01) nounwind, !dbg !2 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_58_count);
  llvm_cbe_tmp__25 = (float ) /*tail*/ apatb_tanh_custom_sw(0x1p-1);
if (AESL_DEBUG_TRACE) {
printf("\nArgument  = %f",0x1p-1);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%33 = tail call float @apatb_tanh_custom_sw(float 1.000000e+00) nounwind, !dbg !2 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_75_count);
  llvm_cbe_tmp__33 = (float ) /*tail*/ apatb_tanh_custom_sw(0x1p0);
if (AESL_DEBUG_TRACE) {
printf("\nArgument  = %f",0x1p0);
