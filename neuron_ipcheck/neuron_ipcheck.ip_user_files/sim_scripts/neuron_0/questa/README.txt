...
#
# Generated by export_simulation on Fri Nov 08 02:53:58 +0530 2024
#
################################################################################
...
'-reset_run' switch to the './neuron_0.sh' script.

./neuron_0.sh -reset_run
...
./neuron_0.sh -noclean_files

For more information on the script, please type './neuron_0.sh -help'.
