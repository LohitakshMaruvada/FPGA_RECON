...
HD_PWD='C:/Users/chait/OneDrive/Desktop/FPGA/Project/tanh/neuron_ipcheck/neuron_ipcheck.runs/MAC_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MAC_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MAC_0.tcl
